from noise.processing.symmetricstate import SymmetricState
from noise.processing.handshakestate import HandshakeState as BaseHandshakeState

from noise.dh.public import PublicKey
from noise.dh.keypair import KeyPair
...
class HandshakeState(BaseHandshakeState):
    ...
    def write_message(self, payload, message_buffer):
        ...
        :return:
        :rtype: tuple[noise.processing.cipherstate.CipherState] | None
        """
