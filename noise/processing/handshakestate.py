class HandshakeState(object):
    def initialize(self, handshake_pattern, initiator, prologue, s=None, e=None, rs=None, re=None, psks=None):
        ...
        :type handshake_pattern: noise.processing.handshakepatterns.handshakepattern.HandshakePattern
        ...
        :type s: noise.dh.keypair.KeyPair
        :param e: local ephemeral key pair
        :type e: noise.dh.keypair.KeyPair | None
        :param rs:  remote party's static public key
        :type rs: noise.dh.public.PublicKey | None
        :param re: remote party's ephemeral public key
        :type re: noise.dh.public.PublicKey | None
    ...
    def write_message(self, payload, message_buffer):
        ...
        :return:
        :rtype: tuple[noise.processing.cipherstate.CipherState, noise.processing.cipherstate.CipherState]|None
        """
